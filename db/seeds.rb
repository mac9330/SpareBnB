...
csv.each do |row|
  ...
  r1 = Review.create(user_id: u.id, spot_id: s.id-3 || s.id, rating: rand(3..5), description: row["comment1"] || null)
  r2 = Review.create(user_id: u.id, spot_id: s.id-1 || s.id, rating: rand(3..5), description: row["comment2"] || null)
  r3 = Review.create(user_id: u.id, spot_id: s.id-2 || s.id, rating: rand(3..5), description: row["comment3"] || null)
