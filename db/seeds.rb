...
csv.each do |row|
  ...
  r1 = Review.create(user_id: u.id-1, spot_id: s.id-3, rating: rand(3..5), description: row["comment1"] || null)
  r2 = Review.create(user_id: u.id-2, spot_id: s.id-1, rating: rand(3..5), description: row["comment2"] || null)
  r3 = Review.create(user_id: u.id-3, spot_id: s.id-2, rating: rand(3..5), description: row["comment3"] || null)
