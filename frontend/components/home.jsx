            ...
            <div className="locations-div">
                ...
                <div className="home-locations">
                    ...
                    <div className="location-container box-1">
                        <Link className="location-link ele-1" to={`/spots?lat=40.730610&lng=-73.935242`}>
                        <span className="location-ele ele-2">
                            <img src="https://a0.muscache.com/im/pictures/87e69a34-0b8d-4489-a3b1-68bb5c2a3547.jpg?aki_policy=large" alt="New York City $119/night avg."/>
                            <span className="location-text ele-3">
                                New York City
                                <p><b>$119</b>/night avg.</p>
                            </span>
                        </span>
                        </Link>
                    </div>
                    ...
                    <div className="location-container box-2">
                        <Link className="location-link" to={`/spots?lat=41.0359353&lng=-71.9545146`}>
                        <span className="location-ele">
                            <img src="https://a0.muscache.com/im/pictures/aec36912-c412-49db-aef4-01bf9d42d2d4.jpg?aki_policy=large" alt="Montauk $795/night avg."/>
                            <span className="location-text" >
                                Montauk 
                                <br/>
                                <p><b>$795</b>/night avg.</p>
                            </span>
                        </span>
                        </Link>
                    </div>
                    ...
                    <div className="location-container box-5">
                        <Link className="location-link" to={`/spots?lat=37.773972&lng=-122.431297`}>
                        <span className="location-ele">
                            <img src="https://i.redd.it/xclduo3xccq11.png" alt="San Fransico $145/night avg."/>
                            <span className="location-text" >
                                San Fransico 
                                <br/>
                                <p><b>$145</b>/night avg.</p>
                            </span>
                        </span>
                        </Link>
                    </div>
